    ...
    <form  onSubmit={onSubmitHandler}  className='flex flex-col w-full items-start gap-3'>
      ...
      <label htmlFor="image4">
       ...
       <div className='w-full'>
        ...
        <input onChange={(e)=>setName(e.target.value)} value={name} className='w-full max-w-[500px] py-2 px-3' type="text" placeholder='Type here' required />
       </div>

       <div className='w-full'>
        <p className='mb-2'>Product Description</p>
        <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className='w-full max-w-[500px] py-2 px-3' type="text" placeholder='Write content here' required />
       </div>
