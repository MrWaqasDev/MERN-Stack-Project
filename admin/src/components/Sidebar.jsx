  ...
  return (
    <div className='w-[18%] min-h-screen border-r-2 border-gray-200' >
        <div className='flex flex-col gap-4 pt-6 pl-[20%] text-[15px]'>
            ...
            <img className='w-5 h-5' src={assets.add_icon} alt="Add add_icon" />
            ...
            <NavLink className='flex items-center gap-2 border border-gray-300 border-r-0 px-3 py-2 rounded-lg'     to='/orders'>
